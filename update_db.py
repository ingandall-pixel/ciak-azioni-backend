...
def get_all_tickers():
    ...
    # 1. MERCATO USA COMPLETO (SEC Registro Ufficiale: ~8.000 titoli)
    tickers_us = []
    try:
        ...
        print(f"Errore recupero SEC USA: {e}")
    ...
    tickers_it = [
        ...
        'MIC.MI', 'MID.MI', 'MIE.MI', 'MIF.MI', 'MIG.MI', 'MII.MI', 'MIL.MI', 'MIM.MI', 'MIN.MI', 'MIP.MI', 
        'MIR.MI', 'MIS.MI', 'MIT.MI', 'MIV.MI', 'MJ.MI', 'MK.MI', 'MKA.MI', 'MKB.MI', 'MKC.MI', 'MKE.MI', 
        'MKL.MI', 'MKM.MI', 'ML.MI', 'MLA.MI', 'MLB.MI', 'MLC.MI', 'MLE.MI', 'MLF.MI', 'MLG.MI', 'MLI.MI', 
        'MLL.MI', 'MLM.MI', 'MLN.MI', 'MLP.MI', 'MLR.MI', 'MLS.MI', 'MLT.MI', 'MM.MI', 'MMA.MI', 'MMB.MI', 
        'MMC.MI', 'MMD.MI', 'MME.MI', 'MMF.MI', 'MMG.MI', 'MMI.MI', 'MML.MI', 'MMM.MI', 'MMN.MI', 'MMP.MI', 
        'MMR.MI', 'MMS.MI', 'MMT.MI', 'MN.MI', 'MNA.MI', 'MNB.MI', 'MNC.MI', 'MND.MI', 'MNE.MI', 'MNF.MI', 
        'MNG.MI', 'MNI.MI', 'MNL.MI', 'MNM.MI', 'MNN.MI', 'MNP.MI', 'MNR.MI', 'MNS.MI', 'MNT.MI', 'MO.MI', 
        'MOA.MI', 'MOB.MI', 'MOC.MI', 'MOD.MI', 'MOE.MI', 'MOF.MI', 'MOG.MI', 'MOI.MI', 'MOL.MI', 'MOM.MI', 
        'MON.MI', 'MONC.MI', 'MOP.MI', 'MOR.MI', 'MOS.MI', 'MOT.MI', 'MP.MI', 'MPA.MI', 'MPB.MI', 'MPC.MI', 
        'MPE.MI', 'MPF.MI', 'MPG.MI', 'MPI.MI', 'MPL.MI', 'MPM.MI', 'MPN.MI', 'MPO.MI', 'MPR.MI', 'MPS.MI', 
        'MPT.MI', 'MR.MI', 'MRA.MI', 'MRB.MI', 'MRC.MI', 'MRD.MI', 'MRE.MI', 'MRF.MI', 'MRG.MI', 'MRI.MI', 
        'MRL.MI', 'MRM.MI', 'MRN.MI', 'MRO.MI', 'MRP.MI', 'MRR.MI', 'MRS.MI', 'MRT.MI', 'MS.MI', 'MSA.MI', 
        'MSB.MI', 'MSC.MI', 'MSD.MI', 'MSE.MI', 'MSF.MI', 'MSG.MI', 'MSI.MI', 'MSL.MI', 'MSM.MI', 'MSN.MI', 
        'MSO.MI', 'MSP.MI', 'MSR.MI', 'MSS.MI', 'MST.MI', 'MT.MI', 'MTA.MI', 'MTB.MI', 'MTC.MI', 'MTD.MI', 
        'MTE.MI', 'MTF.MI', 'MTG.MI', 'MTI.MI', 'MTL.MI', 'MTM.MI', 'MTN.MI', 'MTO.MI', 'MTP.MI', 'MTR.MI', 
        'MTS.MI', 'MTT.MI', 'MU.MI', 'MUA.MI', 'MUB.MI', 'MUC.MI', 'MUD.MI', 'MUE.MI', 'MUF.MI', 'MUG.MI', 
        'MUI.MI', 'MUL.MI', 'MUM.MI', 'MUN.MI', 'MUP.MI', 'MUR.MI', 'MUS.MI', 'MUT.MI', 'MV.MI', 'MVA.MI', 
        'MVB.MI', 'MVC.MI', 'MVE.MI', 'MVF.MI', 'MVG.MI', 'MVI.MI', 'MVL.MI', 'MVM.MI', 'MVN.MI', 'MVP.MI', 
        'MVR.MI', 'MVS.MI', 'MVT.MI', 'MW.MI', 'MX.MI', 'MY.MI', 'MZ.MI', 'NEXI.MI', 'O2A.MI', 'PIA.MI', 
        'PRY.MI', 'PST.MI', 'RACE.MI', 'REC.MI', 'RWAY.MI', 'SAF.MI', 'SFL.MI', 'SL.MI', 'SPM.MI', 'SRG.MI', 
        'STM.MI', 'TEN.MI', 'TIS.MI', 'TIT.MI', 'TOD.MI', 'TRN.MI', 'TXT.MI', 'UCG.MI', 'UNI.MI', 'US.MI', 
        'VLS.MI', 'VTY.MI', 'WBA.MI', 'ZUC.MI'
    ]

    tickers_it = list(set(tickers_it))
...
def download_data():
    ...
    if db_exists:
        ...
        update_progress(5, "Database assente. Download massivo a blocchi (anti-blocco)...")
        period_to_fetch = "5y"

    ALL_TICKERS = get_all_tickers()
    total_tickers = len(ALL_TICKERS)
    
    # Divisione in blocchi da 50 per evitare blocco IP
